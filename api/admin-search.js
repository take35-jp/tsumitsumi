                                                                                                  ...
                                                                                                  targets = JSON.parse(selText);
                                                                                                        ...
                                                                                                        return res.json({ done: true, updated: 0, parseErr: true, sta: selResp.status, txt: selText.slice(0, 300) });
                                                                                                            ...
                                                                                                            if (!Array.isArray(targets) || targets.length === 0) {
                                                                                                                return res.json({ done: true, updated: 0, sta: selResp.status, isArr: Array.isArray(targets), len: Array.isArray(targets) ? targets.length : "n/a", preview: JSON.stringify(targets).slice(0, 300) });
                                                                                                                  }
