...
export default function App() {
  ...
  return (
    <div style={s.root}>
      ...
      <div style={{ background: "#fff", borderBottom: "1px solid #f0f0f0", padding: "8px 20px", display: bulkMode ? "none" : "flex", alignItems: "center", gap: 8, flexWrap: "nowrap", overflowX: "auto" }}>
