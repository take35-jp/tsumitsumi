...
function AllVersionsModal({ onClose }) {
  const versions = [
    { ver: "v1.10", date: "2026/05/02", isNew: true, items: ["ランクを「天照大積ミ神」「神界の積み人」など上位帯（600〜1000）まで追加・既存ラベル調整", "タグの作成・編集・削除ができる「タグ編集」画面を追加（件数・希望小売価格合計も表示）", "一括編集モードのタグ操作を「解除」ボタンに統一", "並び順から「手動順」を削除し、登録順をデフォルトに統一", "ヘルプに「画像を整理して容量を節約」ボタンを追加"] },
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          ...
          <div style={{ background: "#f0fdf4", border: "1.5px solid #bbf7d0", borderRadius: 10, padding: "10px 14px" }}>
            ...
            <div style={{ fontSize: 11, color: "#374151", lineHeight: 1.8 }}>
              ・上位ランク（600〜1000「天照大積ミ神」など）を追加<br/>
